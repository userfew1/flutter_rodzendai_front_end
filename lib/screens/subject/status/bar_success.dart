...
class BarSuccess extends StatefulWidget {
  const BarSuccess({super.key});

  @override
  State<BarSuccess> createState() => _BarSuccessState();
}

class _BarSuccessState extends State<BarSuccess> {
  @override
